...
$: repo init -u https://github.com/iptronix/telsy-community-bsp-platform -b krogoth
$: repo sync
...
Source code::
    https://github.com/iptronix/telsy-community-bsp-platform

When creating patches, please use something like:

[source,console]
$: git format-patch -s --subject-prefix='telsy-community-bsp-platform][PATCH' origin
...
+
[source,console]
$: repo init -u https://github.com/iptronix/telsy-community-bsp-platform -b master
...
[source,console]
$: repo init -u https://github.com/iptronix/telsy-community-bsp-platform -b master-next
